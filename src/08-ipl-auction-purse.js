...
export function iplAuctionSummary(team, players) {
  // Your code here
  if (typeof team !== "object" || team === null || typeof team.purse !== "number" || !Number.isFinite(team.purse) || team.purse <= 0) return null;
  ...
  return {
    teamName: team.name, totalSpent, remaining, playerCount, costliestPlayer, cheapestPlayer, averagePrice, byRole, isOverBudget
  };
